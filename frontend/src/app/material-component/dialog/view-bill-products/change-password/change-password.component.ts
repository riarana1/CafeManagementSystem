...
import { MatLabel, MatFormField, MatError, MatHint } from "@angular/material/input";

@Component({
  selector: 'app-change-password',
  templateUrl: './change-password.component.html',
  styleUrls: ['./change-password.component.scss'],
  imports: [ReactiveFormsModule, MatToolbar, MatIcon, MatToolbarRow, MatDialogContent, MatLabel, MatFormField, MatError, MatDialogActions, MatHint]
})
