...
@Component({
  ...
  imports: [ReactiveFormsModule, MatToolbar, MatToolbarRow, MatIcon, MatDialogContent, MatTableModule, MatFormField, MatLabel, MatError, MatDialogActions, MatOption]
})
