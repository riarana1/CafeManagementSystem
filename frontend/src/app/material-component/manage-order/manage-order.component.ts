...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, MatCard, MatIcon, MatTableModule, MatFormFieldModule, MatOption, MatSelect, MatInputModule, MatButtonModule]
})
export class ManageOrderComponent implements OnInit {
  ...
  add(){
    var fromData = this.manageOrderForm.value;
    var productName = this.dataSource.data.find((e:{id:number}) => e.id === fromData.product.id);
    if(productName === undefined){
      this.totalAmount = this.totalAmount + fromData.total;
      this.dataSource.data.push({id:fromData.product.id , name:fromData.product.name , category:fromData.category.name, quantity:fromData.quantity, price:fromData.price,total:fromData.total});
